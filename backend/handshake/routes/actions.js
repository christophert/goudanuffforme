...
router.get('/getline', function(req, res, next){
	...
	switch(/*Math.floor((Math.random()*17)+1*/3){
		...
		case 2:
			...
			break;
		case 3:
			request('http://api.wordnik.com:80/v4/words.json/randomWord?hasDictionaryDef=false&includePartOfSpeech=verb&minCorpusCount=15000&maxCorpusCount=-1&minDictionaryCount=1&maxDictionaryCount=-1&minLength=3&maxLength=-1&api_key=a2a73e7b926c924fad7001ca3111acd55af2ffabf50eb4ae5', functino(error, response, body){
